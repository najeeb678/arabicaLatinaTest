...
const CustomPagination: React.FC<CustomPaginationProps> = ({
  ...
  return (
    ...
    >
      <Box>
        <Typography
          sx={{ fontWeight: "300", fontSize: "12px", color: "#a44819" }}
        >
      ...
      >
        <Box
          ...
          sx={{
            backgroundColor: page > 0 ? "#FBC02D" : "#E0E0E0",
            width: "28px",
            height: "33px",
            display: "flex",
            alignItems: "center",
        ...
        {pagesToShow.map((pageItem, index) => (
          <Box
            ...
            sx={{
              ...
              justifyContent: "center",
              margin: "0 3px",
              cursor: pageItem === "..." ? "default" : "pointer",
              borderRadius: "4px",
              ...(pageItem === page && {
                color: "#161616",
        ...
        <Box
          ...
          sx={{
            backgroundColor: page < totalPages - 1 ? "#FBC02D" : "#E0E0E0",
            width: "28px",
            height: "33px",
            display: "flex",
            alignItems: "center",
