    ...
    >
      ...
      <Box
        sx={{
          ...
          left: {
            xs: "1%",
            sm: isBelow700 ? "1%" : isBelow800 ? "0%" : "2%",
            md: isBelow1000 ? "2%" : "2%",
            lg: "6%",
          },
      ...
      >
        <Typography
          sx={{
            fontSize: {
              xs: isBelow400 ? "15px" : isBelow500 ? "20px" : "20px",
              sm: isBelow700 ? "25px" : isBelow800 ? "30px" : "35px",
              md: isBelow1000 ? "35px" : "45px",
            },
            color: "#FFFFFF",
          }}
        >
